        ...
        <li className="wd-assignments-list-item list-group-item p-0 mb-5 fs-5 border-gray">
          ...
          <ul className="wd-assignments-sub-list list-group rounded-0">
            {assignments
              ...
              .map((assignment: any) => (
                <li key={assignment._id} className="wd-assignments-sub-list-item list-group-item p-3 ps-1 d-flex align-items-center justify-content-between">
                  ...
                  <div className="col d-flex flex-column align-items-left">
                    ...
                    <span>
                      <span className="text-danger"> Multiple Modules</span> | <b>Not available until</b> {assignment.available_date} | <b>Due</b> {assignment.due_date} | {assignment.points}
                    </span>
                  </div>
                  <div className="col-auto">
                    ...
                    >
                      <FaTrash className="me-1" size={20} style={{ position: "relative", top: "-2px", left: "2px" }} />
                    </button>
                    <LessonControlButtons />
                  </div>
                </li>
              ))}
            <AssignmentDelete assignmentId={assignmentToDelete} />
          </ul>
        </li>
      </ul>
    </div>
